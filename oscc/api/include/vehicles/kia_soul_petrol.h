 ...
 *
 */
#define BRAKE_ACCUMULATOR_PRESSURE_MIN_IN_DECIBARS ( 750.0 )

/*
 * @brief Maximum accumulator pressure. [decibars]
 *
 */
#define BRAKE_ACCUMULATOR_PRESSURE_MAX_IN_DECIBARS ( 850.0 )
 ...
 *
 */
#define BRAKE_PID_RELEASE_SOLENOID_CLAMPED_MAX ( 70.0 )
