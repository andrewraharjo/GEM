...
#define OSCC_MAGIC_EPOS_BYTE_0 ( 0x04 )
#define OSCC_MAGIC_EPOS_BYTE_1 ( 0xff )
#define OSCC_MAGIC_EPOS_SPEED_BYTE_0 ( 0xff )
#define OSCC_MAGIC_EPOS_SPEED_BYTE_1 ( 0xff )
#define CAN_EFF_MASK 0x1FFFFFFFU
#define OSCC_STEERING_COMMAND_CAN_ID 0x18FF00F9
